...
Be sure to utilize the [MYSQL Heroku Deployment Guide](../Supplemental/MySQLHerokuDepyloymentProcess.pdf) in order to deploy your assignment.
...
5. Now you're going to run these SQL files. 
   ...
   * Start MySQL command line tool and login: `cc`.
